...
@section('content')
	...
	<form method="POST" action="{{ route('users.store') }}">
		...
		<div class="form-group row">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control form-control-sm" name="name" id="name" placeholder="Pedro Perez" value="{{ old('name') }}">
				@error('name')
		...
		<div class="form-group row">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control form-control-sm" name="email" id="name" placeholder="newmail@styde.net" value="{{ old('email') }}">
				@error('email')
					<p class= "text-danger"> <small>{{ $message }}</small></p>
